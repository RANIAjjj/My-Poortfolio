      ...
      <header id="header">
        <div className="header-container">
          <div className="header-text">
            ...
            <p className="header-text-description text-slate-500 text-base">
      ...
      <section id="about" className="about-section">
        <div className="about-container shadow-2xl border-current">
          ...
          <div className="about-part2">
            <p className="header-text-title text-3xl font-semibold">
      ...
      <section id="process" className="process-section">
        <div className="process-container">
          <div className="process-title">
            <p className="text-2xl font-semibold">Work Process</p>
          ...
          <div className="process-shapes">
            <div className="shapes-part1">
              <div className="shapes-item hover:shadow-2xl hover:scale-110">
                ...
                <p className="text-sm font-semibold">1. Planning</p>
              ...
              <div className="shapes-item hover:shadow-2xl hover:scale-110">
                ...
                <p className="text-sm font-semibold">2. Coding </p>
                <p className="text-slate-500 text-sm">
            ...
            <div className="shapes-part2">
              <div className="shapes-item hover:shadow-2xl hover:scale-110">
                ...
                <p className="text-sm font-semibold">3. Optimization </p>
                <p className="text-slate-500 text-sm">
              ...
              <div className="shapes-item hover:shadow-2xl hover:scale-110">
                ...
                <p className="text-sm font-semibold">4. Deployment </p>
                <p className="text-slate-500 text-sm">
